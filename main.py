...
while True:
	...
	for file in files:
		...
		next_word = ""
		words = []
		fn = file.replace("S0", ".").replace("S1", ".").replace("S2", ".").replace("s0", ".").replace("s1", ".").replace("s2", ".").replace("numb3rs", "numbers").replace("Numb3rs", "numbers").replace("AC3", "").replace("sg1", "sgeins").replace("SG1", "sgeins").replace("crow_s", "scrubs").replace("SC_", "scrubs_").replace("crow-s", "scrubs_").replace("720p", " ").replace("x264", " ").replace("gtvg-fr", "fringe").replace("futu", "futurama ").replace("lost.girl", "lostgirl").replace("gu10conti2", "continuum 02x").replace("gu10conti3", "continuum 03x").replace("gu10conti1", "continuum 01x").replace("gu10conti4", "continuum 04x").replace("-2brokegirls-", "-twobrokegirls-").replace("G.o.T.", "got").replace("Gam.of.Thros","got")
