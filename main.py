...
dl_video_folder = "/data/Filme_input/sort_series.py/"
other_files_dir = "/data/Serien_input/other files/"
too_less_numbers = "/data/Serien_input/too less numbers/"
too_many_numbers = "/data/Serien_input/too many numbers/"
series_unknown = "/data/Serien_input/series unknown/"
no_exact_match = "/data/Serien_input/no exact match/"
tmp_folder = "/tmp/"
...
class series_database:
	...
	__import_preprocessor_line(self, line_number: int, search: str, replace: str) -> None
...
str2no_lookup = { }  # Search-strings
no2title_lookup = { }  # Title
no2tuning_lookup = { }  # Film
